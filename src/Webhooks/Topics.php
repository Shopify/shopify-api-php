...
final class Topics
{
    ...
    public const APP_SCOPES_UPDATE = 'APP_SCOPES_UPDATE';
    ...
    public const CUSTOMERS_DATA_REQUEST = 'CUSTOMERS_DATA_REQUEST';
    public const CUSTOMERS_DELETE = 'CUSTOMERS_DELETE';
    public const CUSTOMERS_DISABLE = 'CUSTOMERS_DISABLE';
    public const CUSTOMERS_REDACT = 'CUSTOMERS_REDACT';
    ...
    public const CUSTOMERS_PURCHASING_SUMMARY = 'CUSTOMERS_PURCHASING_SUMMARY';
    public const CUSTOMERS_UPDATE = 'CUSTOMERS_UPDATE';
    public const CUSTOMERS_WHATS_APP_MARKETING_CONSENT_UPDATE = 'CUSTOMERS_WHATS_APP_MARKETING_CONSENT_UPDATE';
    ...
    public const CUSTOMER_JOINED_SEGMENT = 'CUSTOMER_JOINED_SEGMENT';
    public const CUSTOMER_LEFT_SEGMENT = 'CUSTOMER_LEFT_SEGMENT';
    ...
    public const DELIVERY_PROMISE_SETTINGS_UPDATE = 'DELIVERY_PROMISE_SETTINGS_UPDATE';
    ...
    public const FINANCE_APP_STAFF_MEMBER_DELETE = 'FINANCE_APP_STAFF_MEMBER_DELETE';
    public const FINANCE_APP_STAFF_MEMBER_GRANT = 'FINANCE_APP_STAFF_MEMBER_GRANT';
    public const FINANCE_APP_STAFF_MEMBER_REVOKE = 'FINANCE_APP_STAFF_MEMBER_REVOKE';
    public const FINANCE_APP_STAFF_MEMBER_UPDATE = 'FINANCE_APP_STAFF_MEMBER_UPDATE';
    public const FINANCE_KYC_INFORMATION_UPDATE = 'FINANCE_KYC_INFORMATION_UPDATE';
    ...
    public const FULFILLMENT_HOLDS_ADDED = 'FULFILLMENT_HOLDS_ADDED';
    public const FULFILLMENT_HOLDS_RELEASED = 'FULFILLMENT_HOLDS_RELEASED';
    ...
    public const FULFILLMENT_ORDERS_MANUALLY_REPORTED_PROGRESS_STOPPED =
    ...
    public const FULFILLMENT_ORDERS_PROGRESS_REPORTED = 'FULFILLMENT_ORDERS_PROGRESS_REPORTED';
    ...
    public const INVENTORY_SHIPMENTS_ADD_ITEMS = 'INVENTORY_SHIPMENTS_ADD_ITEMS';
    public const INVENTORY_SHIPMENTS_CREATE = 'INVENTORY_SHIPMENTS_CREATE';
    public const INVENTORY_SHIPMENTS_DELETE = 'INVENTORY_SHIPMENTS_DELETE';
    public const INVENTORY_SHIPMENTS_MARK_IN_TRANSIT = 'INVENTORY_SHIPMENTS_MARK_IN_TRANSIT';
    public const INVENTORY_SHIPMENTS_RECEIVE_ITEMS = 'INVENTORY_SHIPMENTS_RECEIVE_ITEMS';
    public const INVENTORY_SHIPMENTS_REMOVE_ITEMS = 'INVENTORY_SHIPMENTS_REMOVE_ITEMS';
    public const INVENTORY_SHIPMENTS_UPDATE_ITEM_QUANTITIES = 'INVENTORY_SHIPMENTS_UPDATE_ITEM_QUANTITIES';
    public const INVENTORY_SHIPMENTS_UPDATE_TRACKING = 'INVENTORY_SHIPMENTS_UPDATE_TRACKING';
    public const INVENTORY_TRANSFERS_ADD_ITEMS = 'INVENTORY_TRANSFERS_ADD_ITEMS';
    public const INVENTORY_TRANSFERS_CANCEL = 'INVENTORY_TRANSFERS_CANCEL';
    public const INVENTORY_TRANSFERS_COMPLETE = 'INVENTORY_TRANSFERS_COMPLETE';
    public const INVENTORY_TRANSFERS_READY_TO_SHIP = 'INVENTORY_TRANSFERS_READY_TO_SHIP';
    public const INVENTORY_TRANSFERS_REMOVE_ITEMS = 'INVENTORY_TRANSFERS_REMOVE_ITEMS';
    public const INVENTORY_TRANSFERS_UPDATED = 'INVENTORY_TRANSFERS_UPDATED';
    public const INVENTORY_TRANSFERS_UPDATE_ITEM_QUANTITIES = 'INVENTORY_TRANSFERS_UPDATE_ITEM_QUANTITIES';
    public const LOCALES_CREATE = 'LOCALES_CREATE';
    public const LOCALES_DESTROY = 'LOCALES_DESTROY';
    ...
    public const MARKETS_BACKUP_REGION_UPDATE = 'MARKETS_BACKUP_REGION_UPDATE';
    ...
    public const METAFIELD_DEFINITIONS_CREATE = 'METAFIELD_DEFINITIONS_CREATE';
    public const METAFIELD_DEFINITIONS_DELETE = 'METAFIELD_DEFINITIONS_DELETE';
    public const METAFIELD_DEFINITIONS_UPDATE = 'METAFIELD_DEFINITIONS_UPDATE';
    ...
    public const ORDERS_LINK_REQUESTED = 'ORDERS_LINK_REQUESTED';
    ...
    public const RETURNS_PROCESS = 'RETURNS_PROCESS';
    ...
    public const SHOP_REDACT = 'SHOP_REDACT';
