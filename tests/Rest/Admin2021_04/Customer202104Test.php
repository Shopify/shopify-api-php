...
final class Customer202104Test extends BaseTestCase
{
    ...
    public function test_3(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/2021-04/customers.json?updated_at_min=2022-03-07+16%3A15%3A22",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_4(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/2021-04/customers.json?ids=207119551%2C1073339465",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
