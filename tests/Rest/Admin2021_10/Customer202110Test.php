    ...
    public function test_3(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2021-10/customers.json?updated_at_min=2022-03-29+23%3A38%3A42",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_4(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2021-10/customers.json?ids=207119551%2C1073339476",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_14(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["customer" => ["id" => 207119551, "accepts_marketing" => true, "accepts_marketing_updated_at" => "2022-03-27T19:32:04-04:00", "marketing_opt_in_level" => "confirmed_opt_in"]]),
            ),
        ]);
