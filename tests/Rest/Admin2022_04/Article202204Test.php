...
use Shopify\Context;
use Shopify\Rest\Admin2022_04\Article;
use ShopifyTest\BaseTestCase;
use ShopifyTest\Clients\MockRequest;

final class Article202204Test extends BaseTestCase
{
    /** @var Session */
    ...
    public function test_2(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles.json?since_id=134645308",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_3(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["article" => ["id" => 1051293789, "title" => "My new Article title", "created_at" => "2023-04-04T17:04:59-04:00", "body_html" => "<h1>I like articles</h1>\n<p><strong>Yea</strong>, I like posting them through <span class=\"caps\">REST</span>.</p>", "blog_id" => 241253187, "author" => "John Smith", "user_id" => 548380009, "published_at" => "2011-03-24T11:45:47-04:00", "updated_at" => "2023-04-04T17:04:59-04:00", "summary_html" => null, "template_suffix" => null, "handle" => "my-new-article-title", "tags" => "Has Been Tagged, This Post", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/1051293789"]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles.json",
                "POST",
                null,
    ...
    public function test_4(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["article" => ["id" => 1051293786, "title" => "My new Article title", "created_at" => "2023-04-04T17:04:45-04:00", "body_html" => "<h1>I like articles</h1>\n<p><strong>Yea</strong>, I like posting them through <span class=\"caps\">REST</span>.</p>", "blog_id" => 241253187, "author" => "John Smith", "user_id" => 548380009, "published_at" => "2011-03-24T11:45:47-04:00", "updated_at" => "2023-04-04T17:04:45-04:00", "summary_html" => null, "template_suffix" => null, "handle" => "my-new-article-title", "tags" => "Has Been Tagged, This Post", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/1051293786", "image" => ["created_at" => "2023-04-04T17:04:45-04:00", "alt" => null, "width" => 1, "height" => 1, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/articles/df3e567d6f16d040326c7a0ea29a4f41.gif?v=1680642285"]]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles.json",
                "POST",
                null,
    ...
    public function test_5(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["article" => ["id" => 1051293783, "title" => "My new Article title", "created_at" => "2023-04-04T17:04:32-04:00", "body_html" => "<h1>I like articles</h1>\n<p><strong>Yea</strong>, I like posting them through <span class=\"caps\">REST</span>.</p>", "blog_id" => 241253187, "author" => "John Smith", "user_id" => 548380009, "published_at" => "2011-03-24T11:45:47-04:00", "updated_at" => "2023-04-04T17:04:32-04:00", "summary_html" => null, "template_suffix" => null, "handle" => "my-new-article-title", "tags" => "Has Been Tagged, This Post", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/1051293783"]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles.json",
                "POST",
                null,
    ...
    public function test_6(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["article" => ["id" => 1051293782, "title" => "My new Article title", "created_at" => "2023-04-04T17:04:22-04:00", "body_html" => "<h1>I like articles</h1>\n<p><strong>Yea</strong>, I like posting them through <span class=\"caps\">REST</span>.</p>", "blog_id" => 241253187, "author" => "John Smith", "user_id" => 548380009, "published_at" => "2011-03-24T11:45:47-04:00", "updated_at" => "2023-04-04T17:04:22-04:00", "summary_html" => null, "template_suffix" => null, "handle" => "my-new-article-title", "tags" => "Has Been Tagged, This Post", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/1051293782", "image" => ["created_at" => "2023-04-04T17:04:22-04:00", "alt" => "Rails logo", "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/articles/rails_logo20230404-192446-aiarf8.gif?v=1680642262"]]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles.json",
                "POST",
                null,
    ...
    public function test_7(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["article" => ["id" => 1051293781, "title" => "My new Article title", "created_at" => "2023-04-04T17:04:17-04:00", "body_html" => "<h1>I like articles</h1>\n<p><strong>Yea</strong>, I like posting them through <span class=\"caps\">REST</span>.</p>", "blog_id" => 241253187, "author" => "John Smith", "user_id" => 548380009, "published_at" => null, "updated_at" => "2023-04-04T17:04:17-04:00", "summary_html" => null, "template_suffix" => null, "handle" => "my-new-article-title", "tags" => "Has Been Tagged, This Post", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/1051293781"]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles.json",
                "POST",
                null,
    ...
    public function test_8(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/count.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_9(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/134645308.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_10(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["article" => ["blog_id" => 241253187, "title" => "get on the train now", "handle" => "get-on-the-train-now", "body_html" => "<p>Do <em>you</em> have an <strong>IPod</strong> yet?</p>", "author" => "Dennis", "id" => 134645308, "created_at" => "2008-07-31T20:00:00-04:00", "user_id" => 548380009, "published_at" => "2008-07-31T20:00:00-04:00", "updated_at" => "2023-04-04T17:04:48-04:00", "summary_html" => null, "template_suffix" => null, "tags" => "Announcing", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/134645308", "image" => ["created_at" => "2023-04-04T17:03:11-04:00", "alt" => "iMac", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/articles/imac.jpg?v=1680642191"]]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/134645308.json",
                "PUT",
                null,
                ...
                json_encode(["article" => ["metafields" => [["key" => "new", "value" => "newvalue", "type" => "single_line_text_field", "namespace" => "global"]]]]),
            ),
        ]);
    ...
    public function test_11(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["article" => ["blog_id" => 241253187, "published_at" => null, "title" => "get on the train now", "handle" => "get-on-the-train-now", "body_html" => "<p>Do <em>you</em> have an <strong>IPod</strong> yet?</p>", "author" => "Dennis", "id" => 134645308, "created_at" => "2008-07-31T20:00:00-04:00", "user_id" => 548380009, "updated_at" => "2023-04-04T17:04:18-04:00", "summary_html" => null, "template_suffix" => null, "tags" => "Announcing", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/134645308", "image" => ["created_at" => "2023-04-04T17:03:11-04:00", "alt" => "iMac", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/articles/imac.jpg?v=1680642191"]]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/134645308.json",
                "PUT",
                null,
                ...
                json_encode(["article" => ["published" => false]]),
            ),
        ]);
    ...
    public function test_12(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["article" => ["blog_id" => 241253187, "published_at" => "2023-04-04T17:05:13-04:00", "title" => "get on the train now", "handle" => "get-on-the-train-now", "body_html" => "<p>Do <em>you</em> have an <strong>IPod</strong> yet?</p>", "author" => "Dennis", "id" => 134645308, "created_at" => "2008-07-31T20:00:00-04:00", "user_id" => 548380009, "updated_at" => "2023-04-04T17:05:13-04:00", "summary_html" => null, "template_suffix" => null, "tags" => "Announcing", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/134645308", "image" => ["created_at" => "2023-04-04T17:03:11-04:00", "alt" => "iMac", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/articles/imac.jpg?v=1680642191"]]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/134645308.json",
                "PUT",
                null,
                ...
                json_encode(["article" => ["published" => true]]),
            ),
        ]);
    ...
    public function test_13(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["article" => ["blog_id" => 241253187, "updated_at" => "2023-04-04T17:05:01-04:00", "id" => 134645308, "title" => "get on the train now", "created_at" => "2008-07-31T20:00:00-04:00", "body_html" => "<p>Do <em>you</em> have an <strong>IPod</strong> yet?</p>", "author" => "Dennis", "user_id" => 548380009, "published_at" => "2008-07-31T20:00:00-04:00", "summary_html" => null, "template_suffix" => null, "handle" => "get-on-the-train-now", "tags" => "Announcing", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/134645308"]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/134645308.json",
                "PUT",
                null,
    ...
    public function test_14(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["article" => ["blog_id" => 241253187, "author" => "Your name", "body_html" => "<p>Look, I can even update through a web service.</p>", "published_at" => "2011-03-24T11:45:47-04:00", "title" => "My new Title", "updated_at" => "2023-04-04T17:05:04-04:00", "id" => 134645308, "created_at" => "2008-07-31T20:00:00-04:00", "user_id" => null, "summary_html" => null, "template_suffix" => null, "handle" => "get-on-the-train-now", "tags" => "Tags, Updated, Will Be", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/134645308", "image" => ["created_at" => "2023-04-04T17:05:04-04:00", "alt" => null, "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/articles/fd43f2c8883f6e9b680e3295fd990d2c.gif?v=1680642304"]]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/134645308.json",
                "PUT",
                null,
    ...
    public function test_15(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["article" => ["blog_id" => 241253187, "author" => "Your name", "body_html" => "<p>Look, I can even update through a web service.</p>", "published_at" => "2011-03-24T11:45:47-04:00", "title" => "My new Title", "handle" => "get-on-the-train-now", "user_id" => null, "id" => 134645308, "created_at" => "2008-07-31T20:00:00-04:00", "updated_at" => "2023-04-04T17:05:11-04:00", "summary_html" => null, "template_suffix" => null, "tags" => "Tags, Updated, Will Be", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/134645308", "image" => ["created_at" => "2023-04-04T17:03:11-04:00", "alt" => "iMac", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/articles/imac.jpg?v=1680642191"]]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/134645308.json",
                "PUT",
                null,
                ...
                json_encode(["article" => ["title" => "My new Title", "author" => "Your name", "tags" => "Tags, Will Be, Updated", "body_html" => "<p>Look, I can even update through a web service.</p>", "published_at" => "Thu Mar 24 15:45:47 UTC 2011"]]),
            ),
        ]);
    ...
    public function test_16(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["article" => ["blog_id" => 241253187, "author" => "Your name", "body_html" => "<p>Look, I can even update through a web service.</p>", "published_at" => "2011-03-24T11:45:47-04:00", "title" => "My new Title", "handle" => "get-on-the-train-now", "id" => 134645308, "created_at" => "2008-07-31T20:00:00-04:00", "user_id" => null, "updated_at" => "2023-04-04T17:04:28-04:00", "summary_html" => null, "template_suffix" => null, "tags" => "Tags, Updated, Will Be", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/134645308", "image" => ["created_at" => "2023-04-04T17:04:27-04:00", "alt" => "Rails logo", "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/articles/rails_logo20230404-192446-gywkfe.gif?v=1680642268"]]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/134645308.json",
                "PUT",
                null,
                ...
                json_encode(["article" => ["title" => "My new Title", "author" => "Your name", "tags" => "Tags, Will Be, Updated", "body_html" => "<p>Look, I can even update through a web service.</p>", "published_at" => "Thu Mar 24 15:45:47 UTC 2011", "image" => ["alt" => "Rails logo"]]]),
            ),
        ]);
    ...
    public function test_18(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2022-04/articles/authors.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_19(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2022-04/articles/tags.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_20(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2022-04/articles/tags.json?limit=1&popular=1",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_21(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/tags.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_22(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/tags.json?limit=1&popular=1",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
