...
final class Checkout202204Test extends BaseTestCase
{
    ...
    public function test_10(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["shipping_rates" => [["id" => "shopify-Free Shipping-0.00", "price" => "0.00", "title" => "Free Shipping", "checkout" => ["total_tax" => "0.00", "total_price" => "398.00", "subtotal_price" => "398.00"], "phone_required" => false, "delivery_range" => null, "estimated_time_in_transit" => null, "handle" => "shopify-Free Shipping-0.00"]]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-04/checkouts/exuw7apwoycchjuwtiqg8nytfhphr62a/shipping_rates.json",
                "GET",
                null,
