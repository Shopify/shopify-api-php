...
final class CustomCollection202204Test extends BaseTestCase
{
    ...
    public function test_4(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["custom_collections" => [["id" => 1063001328, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-10-03T12:24:03-04:00", "body_html" => null, "published_at" => "2022-10-03T12:24:03-04:00", "sort_order" => "best-selling", "template_suffix" => null, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001328"]]]
                )),
    ...
    public function test_5(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["custom_collection" => ["id" => 1063001313, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-10-03T12:23:10-04:00", "body_html" => null, "published_at" => null, "sort_order" => "best-selling", "template_suffix" => null, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001313"]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections.json",
                "POST",
                null,
    ...
    public function test_6(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["custom_collection" => ["id" => 1063001315, "handle" => "ipods-1", "title" => "IPods", "updated_at" => "2022-10-03T12:23:13-04:00", "body_html" => null, "published_at" => "2022-10-03T12:23:13-04:00", "sort_order" => "best-selling", "template_suffix" => null, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001315"]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections.json",
                "POST",
                null,
    ...
    public function test_7(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["custom_collection" => ["id" => 1063001319, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-10-03T12:23:29-04:00", "body_html" => null, "published_at" => "2022-10-03T12:23:29-04:00", "sort_order" => "best-selling", "template_suffix" => null, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001319"]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections.json",
                "POST",
                null,
    ...
    public function test_9(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["custom_collection" => ["id" => 1063001324, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-10-03T12:23:44-04:00", "body_html" => null, "published_at" => "2022-10-03T12:23:44-04:00", "sort_order" => "best-selling", "template_suffix" => null, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001324"]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections.json",
                "POST",
                null,
    ...
    public function test_18(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["custom_collection" => ["body_html" => "<p>The best selling ipod ever</p>", "handle" => "ipods", "updated_at" => "2022-10-03T12:23:53-04:00", "id" => 841564295, "sort_order" => "manual", "title" => "IPods", "template_suffix" => null, "published_at" => "2008-02-01T19:00:00-05:00", "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295"]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections/841564295.json",
                "PUT",
                null,
                ...
                json_encode(["custom_collection" => ["image" => "", "updated_at" => "2022-10-03T12:23:53-04:00", "title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => null, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295"]]),
            ),
        ]);
