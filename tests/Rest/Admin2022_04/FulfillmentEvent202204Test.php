...
use Shopify\Context;
use Shopify\Rest\Admin2022_04\FulfillmentEvent;
use ShopifyTest\BaseTestCase;
use ShopifyTest\Clients\MockRequest;

final class FulfillmentEvent202204Test extends BaseTestCase
{
    /** @var Session */
    ...
    public function test_4(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2022-04/orders/450789469/fulfillments/255858046/events/944956395.json",
                "DELETE",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
