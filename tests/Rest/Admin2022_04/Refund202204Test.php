...
final class Refund202204Test extends BaseTestCase
{
    ...
    public function test_5(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["refund" => ["shipping" => ["amount" => "5.00", "tax" => "0.00", "maximum_refundable" => "5.00"], "duties" => [], "total_duties_set" => ["shop_money" => ["amount" => "0.00", "currency_code" => "USD"], "presentment_money" => ["amount" => "0.00", "currency_code" => "USD"]], "additional_fees" => [], "total_additional_fees_set" => ["shop_money" => ["amount" => "0.00", "currency_code" => "USD"], "presentment_money" => ["amount" => "0.00", "currency_code" => "USD"]], "refund_line_items" => [["quantity" => 1, "line_item_id" => 518995019, "location_id" => null, "restock_type" => "no_restock", "price" => "199.00", "subtotal" => "195.67", "total_tax" => "3.98", "discounted_price" => "199.00", "discounted_total_price" => "199.00", "total_cart_discount_amount" => "3.33"]], "transactions" => [["order_id" => 450789469, "kind" => "suggested_refund", "gateway" => "bogus", "parent_id" => 801038806, "amount" => "41.94", "currency" => "USD", "maximum_refundable" => "41.94"]], "currency" => "USD"]]
                )),
    ...
    public function test_7(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["refund" => ["shipping" => ["amount" => "2.00", "tax" => "0.00", "maximum_refundable" => "5.00"], "duties" => [], "total_duties_set" => ["shop_money" => ["amount" => "0.00", "currency_code" => "USD"], "presentment_money" => ["amount" => "0.00", "currency_code" => "USD"]], "additional_fees" => [], "total_additional_fees_set" => ["shop_money" => ["amount" => "0.00", "currency_code" => "USD"], "presentment_money" => ["amount" => "0.00", "currency_code" => "USD"]], "refund_line_items" => [], "transactions" => [["order_id" => 450789469, "kind" => "suggested_refund", "gateway" => "bogus", "parent_id" => 801038806, "amount" => "2.00", "currency" => "USD", "maximum_refundable" => "41.94"]], "currency" => "USD"]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-04/orders/450789469/refunds/calculate.json",
                "POST",
                null,
