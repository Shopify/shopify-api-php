...
final class Collect202207Test extends BaseTestCase
{
        ...
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["collect" => ["id" => 1071559574, "collection_id" => 841564295, "product_id" => 921728736, "created_at" => "2022-07-02T01:56:03-04:00", "updated_at" => "2022-07-02T01:56:03-04:00", "position" => 2, "sort_value" => "0000000002"]]
                )),
    ...
    public function test_4(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["collects" => [["id" => 455204334, "collection_id" => 841564295, "product_id" => 632910392, "created_at" => null, "updated_at" => null, "position" => 1, "sort_value" => "0000000001"], ["id" => 1071559576, "collection_id" => 841564295, "product_id" => 921728736, "created_at" => "2022-07-02T01:56:14-04:00", "updated_at" => "2022-07-02T01:56:14-04:00", "position" => 2, "sort_value" => "0000000002"]]]
                )),
