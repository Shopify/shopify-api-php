...
use Shopify\Context;
use Shopify\Rest\Admin2022_07\Currency;
use ShopifyTest\BaseTestCase;
use ShopifyTest\Clients\MockRequest;

final class Currency202207Test extends BaseTestCase
{
    /** @var Session */
    ...
    public function test_1(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2022-07/currencies.json",
                "GET",
                null,
                [
