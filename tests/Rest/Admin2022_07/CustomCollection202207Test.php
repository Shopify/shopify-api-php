...
final class CustomCollection202207Test extends BaseTestCase
{
    ...
    public function test_3(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["custom_collections" => [["id" => 1063001316, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2023-07-11T18:03:50-04:00", "body_html" => null, "published_at" => "2023-07-11T18:03:50-04:00", "sort_order" => "best-selling", "template_suffix" => null, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001316"]]]
                )),
    ...
    public function test_12(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["custom_collection" => ["body_html" => "<p>The best selling ipod ever</p>", "handle" => "ipods", "updated_at" => "2023-07-11T18:03:48-04:00", "id" => 841564295, "sort_order" => "manual", "title" => "IPods", "template_suffix" => null, "published_at" => "2008-02-01T19:00:00-05:00", "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295"]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections/841564295.json",
                "PUT",
                null,
                ...
                json_encode(["custom_collection" => ["image" => "", "updated_at" => "2023-07-11T18:03:47-04:00", "title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => null, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295"]]),
            ),
        ]);
    ...
    public function test_17(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["custom_collection" => ["id" => 1063001326, "handle" => "ipods-1", "title" => "IPods", "updated_at" => "2023-07-11T18:04:39-04:00", "body_html" => null, "published_at" => "2023-07-11T18:04:39-04:00", "sort_order" => "best-selling", "template_suffix" => null, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001326"]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections.json",
                "POST",
                null,
    ...
    public function test_18(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["custom_collection" => ["id" => 1063001322, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2023-07-11T18:04:28-04:00", "body_html" => null, "published_at" => "2023-07-11T18:04:28-04:00", "sort_order" => "best-selling", "template_suffix" => null, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001322"]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections.json",
                "POST",
                null,
    ...
    public function test_19(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["custom_collection" => ["id" => 1063001314, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2023-07-11T18:03:40-04:00", "body_html" => null, "published_at" => "2023-07-11T18:03:40-04:00", "sort_order" => "best-selling", "template_suffix" => null, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001314"]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections.json",
                "POST",
                null,
    ...
    public function test_20(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["custom_collection" => ["id" => 1063001311, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2023-07-11T18:03:30-04:00", "body_html" => null, "published_at" => "2023-07-11T18:03:29-04:00", "sort_order" => "best-selling", "template_suffix" => null, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001311", "image" => ["created_at" => "2023-07-11T18:03:30-04:00", "alt" => "Rails Logo", "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/rails_logo20230711-85514-wsnj5w.gif?v=1689113010"]]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections.json",
                "POST",
                null,
    ...
    public function test_21(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["custom_collection" => ["id" => 1063001317, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2023-07-11T18:03:54-04:00", "body_html" => null, "published_at" => null, "sort_order" => "best-selling", "template_suffix" => null, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001317"]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections.json",
                "POST",
                null,
