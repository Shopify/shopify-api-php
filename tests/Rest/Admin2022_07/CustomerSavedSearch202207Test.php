...
final class CustomerSavedSearch202207Test extends BaseTestCase
{
    ...
    public function test_3(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["customer_saved_search" => ["id" => 1068136102, "name" => "Spent more than \$50", "created_at" => "2022-07-02T02:07:37-04:00", "updated_at" => "2022-07-02T02:07:37-04:00", "query" => "total_spent:>50"]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-07/customer_saved_searches.json",
                "POST",
                null,
    ...
    public function test_4(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["customer_saved_search" => ["id" => 1068136103, "name" => "Spent more than \$50 and after 2013", "created_at" => "2022-07-02T02:07:38-04:00", "updated_at" => "2022-07-02T02:07:38-04:00", "query" => "total_spent:>50 order_date:>=2013-01-01"]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-07/customer_saved_searches.json",
                "POST",
                null,
    ...
    public function test_7(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["customer_saved_search" => ["id" => 789629109, "name" => "Accepts Marketing", "created_at" => "2022-06-25T01:51:59-04:00", "updated_at" => "2022-06-25T01:51:59-04:00", "query" => "accepts_marketing:1"]]
                )),
    ...
    public function test_8(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["customer_saved_search" => ["name" => "This Name Has Been Changed", "id" => 789629109, "created_at" => "2022-06-25T01:51:59-04:00", "updated_at" => "2022-07-02T02:07:40-04:00", "query" => "accepts_marketing:1"]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-07/customer_saved_searches/789629109.json",
                "PUT",
                null,
