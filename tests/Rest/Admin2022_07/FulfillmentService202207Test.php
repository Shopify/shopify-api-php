...
use Shopify\Context;
use Shopify\Rest\Admin2022_07\FulfillmentService;
use ShopifyTest\BaseTestCase;
use ShopifyTest\Clients\MockRequest;

final class FulfillmentService202207Test extends BaseTestCase
{
    /** @var Session */
    ...
    public function test_1(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2022-07/fulfillment_services.json?scope=all",
                "GET",
                null,
                [
    ...
    public function test_4(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2022-07/fulfillment_services/755357713.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
