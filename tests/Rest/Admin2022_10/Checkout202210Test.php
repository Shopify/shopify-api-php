...
use Shopify\Context;
use Shopify\Rest\Admin2022_10\Checkout;
use ShopifyTest\BaseTestCase;
use ShopifyTest\Clients\MockRequest;

final class Checkout202210Test extends BaseTestCase
{
    /** @var Session */
        ...
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["checkout" => ["completed_at" => null, "created_at" => "2023-04-04T17:42:02-04:00", "currency" => "USD", "presentment_currency" => "USD", "customer_id" => null, "customer_locale" => "en", "device_id" => null, "discount_code" => null, "discount_codes" => [], "email" => null, "legal_notice_url" => null, "location_id" => null, "name" => "#1066348320", "note" => "", "note_attributes" => [], "order_id" => null, "order_status_url" => null, "order" => null, "payment_due" => "995.00", "payment_url" => "https://app.local/cardserver/sessions", "payments" => [], "phone" => null, "shopify_payments_account_id" => null, "privacy_policy_url" => null, "refund_policy_url" => null, "requires_shipping" => true, "reservation_time_left" => 0, "reservation_time" => null, "source_identifier" => null, "source_name" => "755357713", "source_url" => null, "subscription_policy_url" => null, "subtotal_price" => "995.00", "shipping_policy_url" => null, "tax_exempt" => false, "taxes_included" => false, "terms_of_sale_url" => null, "terms_of_service_url" => null, "token" => "87473985bfc9618bd689b97fb7d7f6b1", "total_price" => "995.00", "total_tax" => "0.00", "total_tip_received" => "0.00", "total_line_items_price" => "995.00", "updated_at" => "2023-04-04T17:42:02-04:00", "user_id" => null, "web_url" => "https://jsmith.myshopify.com/548380009/checkouts/87473985bfc9618bd689b97fb7d7f6b1", "total_duties" => null, "total_additional_fees" => null, "line_items" => [["id" => "61bfcf5681f77912b75cc248a730ee76", "key" => "61bfcf5681f77912b75cc248a730ee76", "product_id" => 632910392, "variant_id" => 39072856, "sku" => "IPOD2008GREEN", "vendor" => "Apple", "title" => "IPod Nano - 8GB", "variant_title" => "Green", "image_url" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/products/ipod-nano.png?v=1680642807", "taxable" => true, "requires_shipping" => true, "gift_card" => false, "price" => "199.00", "compare_at_price" => null, "line_price" => "995.00", "properties" => [], "quantity" => 5, "grams" => 567, "fulfillment_service" => "manual", "applied_discounts" => [], "discount_allocations" => [], "tax_lines" => []]], "gift_cards" => [], "tax_lines" => [], "tax_manipulations" => [], "shipping_line" => null, "shipping_rate" => null, "shipping_address" => null, "credit_card" => null, "billing_address" => null, "applied_discount" => null, "applied_discounts" => [], "discount_violations" => []]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-10/checkouts.json",
                "POST",
                null,
                [
    ...
    public function test_2(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, json_encode(
                  ["checkout" => ["completed_at" => null, "created_at" => "2023-04-04T17:41:46-04:00", "currency" => "USD", "presentment_currency" => "USD", "customer_id" => 1073339463, "customer_locale" => "en", "device_id" => null, "discount_code" => null, "discount_codes" => [], "email" => "me@example.com", "legal_notice_url" => null, "location_id" => null, "name" => "#1066348319", "note" => "", "note_attributes" => [], "order_id" => null, "order_status_url" => null, "order" => null, "payment_due" => "0.00", "payment_url" => "https://app.local/cardserver/sessions", "payments" => [], "phone" => null, "shopify_payments_account_id" => null, "privacy_policy_url" => null, "refund_policy_url" => null, "requires_shipping" => false, "reservation_time_left" => 0, "reservation_time" => null, "source_identifier" => null, "source_name" => "755357713", "source_url" => null, "subscription_policy_url" => null, "subtotal_price" => "0.00", "shipping_policy_url" => null, "tax_exempt" => false, "taxes_included" => false, "terms_of_sale_url" => null, "terms_of_service_url" => null, "token" => "ca2e31c97889b6cb5101eb356323e154", "total_price" => "0.00", "total_tax" => "0.00", "total_tip_received" => "0.00", "total_line_items_price" => "0.00", "updated_at" => "2023-04-04T17:41:46-04:00", "user_id" => null, "web_url" => "https://jsmith.myshopify.com/548380009/checkouts/ca2e31c97889b6cb5101eb356323e154", "total_duties" => null, "total_additional_fees" => null, "line_items" => [], "gift_cards" => [], "tax_lines" => [], "tax_manipulations" => [], "shipping_line" => null, "shipping_rate" => null, "shipping_address" => null, "credit_card" => null, "billing_address" => null, "applied_discount" => null, "applied_discounts" => [], "discount_violations" => []]]
                )),
                "https://test-shop.myshopify.io/admin/api/2022-10/checkouts.json",
                "POST",
                null,
    ...
    public function test_5(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2022-10/checkouts/7yjf4v2we7gamku6a6h7tvm8h3mmvs4x.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_6(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2022-10/checkouts/exuw7apwoycchjuwtiqg8nytfhphr62a.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_9(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2022-10/checkouts/exuw7apwoycchjuwtiqg8nytfhphr62a/shipping_rates.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_11(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2022-10/checkouts/zs9ru89kuqcdagk8bz4r9hnxt22wwd42/shipping_rates.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
