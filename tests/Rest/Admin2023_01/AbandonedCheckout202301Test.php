...
use Shopify\Context;
use Shopify\Rest\Admin2023_01\AbandonedCheckout;
use ShopifyTest\BaseTestCase;
use ShopifyTest\Clients\MockRequest;

final class AbandonedCheckout202301Test extends BaseTestCase
{
    /** @var Session */
    ...
    public function test_1(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2023-01/checkouts.json?created_at_max=2013-10-12T07%3A05%3A27-02%3A00",
                "GET",
                null,
                [
    ...
    public function test_3(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2023-01/checkouts.json?status=closed",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_4(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2023-01/checkouts.json?limit=1",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
