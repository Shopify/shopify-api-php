...
use Shopify\Context;
use Shopify\Rest\Admin2023_01\GiftCardAdjustment;
use ShopifyTest\BaseTestCase;
use ShopifyTest\Clients\MockRequest;

final class GiftCardAdjustment202301Test extends BaseTestCase
{
    /** @var Session */
    ...
    public function test_1(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2023-01/gift_cards/1035197676/adjustments.json",
                "GET",
                null,
                [
    ...
    public function test_5(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["adjustment" => ["amount" => 10.0, "processed_at" => "2023-07-02T09:31:20-04:00"]]),
            ),
        ]);
    ...
    public function test_6(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2023-01/gift_cards/1035197676/adjustments/1064273908.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
