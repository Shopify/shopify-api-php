...
use Shopify\Context;
use Shopify\Rest\Admin2023_07\DisputeEvidence;
use ShopifyTest\BaseTestCase;
use ShopifyTest\Clients\MockRequest;

final class DisputeEvidence202307Test extends BaseTestCase
{
    /** @var Session */
    ...
    public function test_1(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2023-07/shopify_payments/disputes/598735659/dispute_evidences.json",
                "GET",
                null,
                [
