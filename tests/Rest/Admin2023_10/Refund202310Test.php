...
use Shopify\Context;
use Shopify\Rest\Admin2023_10\Refund;
use ShopifyTest\BaseTestCase;
use ShopifyTest\Clients\MockRequest;

final class Refund202310Test extends BaseTestCase
{
    /** @var Session */
    ...
    public function test_1(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2023-10/orders/450789469/refunds.json",
                "GET",
                null,
                [
    ...
    public function test_4(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2023-10/orders/450789469/refunds/509562969.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_5(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2023-10/orders/450789469/refunds/calculate.json",
                "POST",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
