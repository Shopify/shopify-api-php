...
use Shopify\Context;
use Shopify\Rest\Admin2023_10\ShippingZone;
use ShopifyTest\BaseTestCase;
use ShopifyTest\Clients\MockRequest;

final class ShippingZone202310Test extends BaseTestCase
{
    /** @var Session */
    ...
    public function test_1(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2023-10/shipping_zones.json",
                "GET",
                null,
                [
