...
use Shopify\Context;
use Shopify\Rest\Admin2024_01\UsageCharge;
use ShopifyTest\BaseTestCase;
use ShopifyTest\Clients\MockRequest;

final class UsageCharge202401Test extends BaseTestCase
{
    /** @var Session */
    ...
    public function test_1(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2024-01/recurring_application_charges/455696195/usage_charges.json",
                "POST",
                null,
                [
    ...
    public function test_3(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2024-01/recurring_application_charges/455696195/usage_charges/1034618211.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
