...
use Shopify\Context;
use Shopify\Rest\Admin2024_04\LocationsForMove;
use ShopifyTest\BaseTestCase;
use ShopifyTest\Clients\MockRequest;

final class LocationsForMove202404Test extends BaseTestCase
{
    /** @var Session */
    ...
    public function test_1(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2024-04/fulfillment_orders/1046000782/locations_for_move.json",
                "GET",
                null,
                [
