...
use Shopify\Context;
use Shopify\Rest\Admin2024_07\DisputeEvidence;
    ...
    public function test_1(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2024-07/shopify_payments/disputes/598735659/dispute_evidences.json",
                "GET",
                null,
                [
