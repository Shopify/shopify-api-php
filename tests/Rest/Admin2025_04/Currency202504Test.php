...
use Shopify\Context;
use Shopify\Rest\Admin2025_04\Currency;
use ShopifyTest\BaseTestCase;
use ShopifyTest\Clients\MockRequest;

final class Currency202504Test extends BaseTestCase
{
    /** @var Session */
    ...
    public function test_1(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2025-04/currencies.json",
                "GET",
                null,
                [
