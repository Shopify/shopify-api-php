...
use Shopify\Context;
use Shopify\Rest\Admin2025_04\Shop;
use ShopifyTest\BaseTestCase;
use ShopifyTest\Clients\MockRequest;

final class Shop202504Test extends BaseTestCase
{
    /** @var Session */
    ...
    public function test_1(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2025-04/shop.json",
                "GET",
                null,
                [
    ...
    public function test_2(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2025-04/shop.json?fields=address1%2Caddress2%2Ccity%2Cprovince%2Ccountry",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
