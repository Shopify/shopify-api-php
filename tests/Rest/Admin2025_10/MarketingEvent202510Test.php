...
use Shopify\Context;
use Shopify\Rest\Admin2025_10\MarketingEvent;
use ShopifyTest\BaseTestCase;
use ShopifyTest\Clients\MockRequest;

final class MarketingEvent202510Test extends BaseTestCase
{
    /** @var Session */
    ...
    public function test_1(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2025-10/marketing_events.json",
                "GET",
                null,
                [
    ...
    public function test_2(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["marketing_event" => ["started_at" => "2024-12-15", "utm_campaign" => "Christmas2024", "utm_source" => "facebook", "utm_medium" => "cpc", "event_type" => "ad", "referring_domain" => "facebook.com", "marketing_channel" => "social", "paid" => true]]),
            ),
        ]);
    ...
    public function test_3(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2025-10/marketing_events/count.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_4(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2025-10/marketing_events/998730532.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_5(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["marketing_event" => ["remote_id" => "1000:2000", "started_at" => "2024-02-02T00:00 +00:00", "ended_at" => "2024-02-03T00:00 +00:00", "scheduled_to_end_at" => "2024-02-04T00:00 +00:00", "budget" => "11.1", "budget_type" => "daily", "currency" => "CAD", "utm_campaign" => "other", "utm_source" => "other", "utm_medium" => "other", "event_type" => "ad", "referring_domain" => "instagram.com"]]),
            ),
        ]);
    ...
    public function test_7(): void
    {
        ...
        $marketing_event->engagements(
            [],
            ["engagements" => [["occurred_on" => "2024-01-15", "views_count" => 0, "clicks_count" => 0, "favorites_count" => 0, "ad_spend" => 10.0, "is_cumulative" => true], ["occurred_on" => "2024-01-16", "views_count" => 100, "clicks_count" => 50, "is_cumulative" => true], ["occurred_on" => "2024-01-17", "views_count" => 200, "clicks_count" => 100, "is_cumulative" => true]]],
        );
    }
