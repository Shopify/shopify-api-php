...
use Shopify\Context;
use Shopify\Rest\Admin2025_10\Payout;
use ShopifyTest\BaseTestCase;
use ShopifyTest\Clients\MockRequest;

final class Payout202510Test extends BaseTestCase
{
    /** @var Session */
    ...
    public function test_1(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2025-10/shopify_payments/payouts.json",
                "GET",
                null,
                [
    ...
    public function test_2(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2025-10/shopify_payments/payouts.json?date_max=2012-11-12",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_3(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2025-10/shopify_payments/payouts/623721858.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
